...
function reportAbsence(instanceId, professorNameToMarkAbsent) {
  ...
  try {
    ...
    if (!professorNameToMarkAbsent || typeof professorNameToMarkAbsent !== 'string' || professorNameToMarkAbsent.trim() === '')
      throw new Error('Nome do Professor ausente inválido ou ausente.');
